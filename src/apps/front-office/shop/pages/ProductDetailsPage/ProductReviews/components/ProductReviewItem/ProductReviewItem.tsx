...
export default function ProductReviewItem(props: ProductReviewItemProps) {
  return (
    <>
      <li className="flex gap-2 md:gap-5">
        ...
        <div>
          <h3 className="block text-sm text-primary-default font-semibold">Eman Awaad</h3>
          <span className="date block text-xs md:text-sm text-gray-400 mb-1">December 4, 2024 at 3:12 pm</span>
