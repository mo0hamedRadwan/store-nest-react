      ...
      <div className="nav-links w-full">
        ...
        />
                            ...
                            <div className="py-[150px] w-full flex justify-center">
                              <div className="">
                                <img className="" src="https://nest-frontend-v6.netlify.app/assets/imgs/page/reset_password.svg" alt=""/>
                                <h2 className="text-[40px] font-bold my-[15px]">Set new password</h2>
                                <p className="text-[16px] mb-[30px]">Please create a new password that you don’t use on any other site.</p>
