...
export const apiClient = import.meta.env.APP_CLIENT_ID;
export const apiAuthToken = import.meta.env.APP_API_TOKEN;
...
=======
export const appClientId = import.meta.env.APP_CLIENT_ID;
